...
[![YouTube](https://img.shields.io/badge/Subscribe-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/@ManeeshCodeLab?sub_confirmation=1)&nbsp;
[![YouTube Subscribers](https://img.shields.io/youtube/channel/subscribers/UCWehNf2SEN1InUh_P4z3rgA?style=for-the-badge&logo=youtube&logoColor=white&label=Subscribers&color=FF0000&labelColor=0D1117)](https://www.youtube.com/@ManeeshCodeLab)&nbsp;
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/AutomateCodeLab)&nbsp;
...
```mermaid
flowchart LR
    E1["Ep 1\nWhat Is an Agent?"] --> E2["Ep 2\nBuild One From Scratch"]
    E2 --> E3["Ep 3\nReal Tools"]
    E3 --> E4["Ep 4\nMulti-Agent Team"]
    E4 --> E5["Ep 5\nAgent Memory"]
    E5 --> E6["Ep 6\nGuardrails & Safety"]

    style E1 fill:#0D1117,color:#A8D8EA,stroke:#0078D4
    style E2 fill:#0D1117,color:#A8D8EA,stroke:#0078D4
    style E3 fill:#0D1117,color:#A8D8EA,stroke:#0078D4
    style E4 fill:#0D1117,color:#A8D8EA,stroke:#0078D4
    style E5 fill:#0D1117,color:#A8D8EA,stroke:#0078D4
    style E6 fill:#B21F1F,color:#fff,stroke:#8B0000
```
